...
@Table(keyspace = "Supplier", name = "order_by_carrier")
public class OrderByCarrier {
	@PartitionKey(0)
	private int o_w_id;
	@PartitionKey(1)
    private int o_d_id;
    ...
    public OrderByCarrier(){
    }
    
    public OrderByCarrier(int o_w_id, int o_d_id, int o_carrier_id, int o_id) {
    	this.o_w_id = o_w_id;
    	this.o_d_id = o_d_id;
